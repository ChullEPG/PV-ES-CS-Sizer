...
def objective_function(x, a):
    ...
    #for year in range(a['Rproj']):
        ...
        # Initialize battery repurchase cost, residual value, and cost of trickle charging (these are all zero at beginning and change throughout)
        ...
        value_of_charging_saved_by_pv_from_loadshedding = economic_analysis.get_value_of_resiliency(year, saved_free_kWh, a)
